...
def main() -> None:
    ...
    try:
        ...
        commands = {
    		'cscantifraud-controldetectionflowbyeventidandaction': controldetectionflowbyeventidandaction_command,
			'cscantifraud-fetchthedetectiondataandconverttopdf': fetchthedetectiondataandconverttopdf_command,
			'cscantifraud-fetchthephishkitdatawithticketid': fetchthephishkitdatawithticketid_command,
			'cscantifraud-fetchthescreenshotdatawithticketid': fetchthescreenshotdatawithticketid_command,
			'cscantifraud-fetchtheticketdataandconverttopdf': fetchtheticketdataandconverttopdf_command,
			'cscantifraud-gethtmlsourcecodeforaticket': gethtmlsourcecodeforaticket_command,
			'cscantifraud-getlistofbrands': getlistofbrands_command,
			'cscantifraud-getlistoffraudtypes': getlistoffraudtypes_command,
			'cscantifraud-listofworklogsforticketid': listofworklogsforticketid_command,
			'cscantifraud-listtakedownevents': listtakedownevents_command,
			'cscantifraud-listtakedowneventswithfilters': listtakedowneventswithfilters_command,
			'cscantifraud-performanactiononasingletarget': performanactiononasingletarget_command,
			'cscantifraud-retrieveeventscreenshotwitheventid': retrieveeventscreenshotwitheventid_command,
			'cscantifraud-retrievefilteredlistofmonitoringresultswithinspecifiedtimeframe': retrievefilteredlistofmonitoringresultswithinspecifiedtimeframe_command,
			'cscantifraud-retrievelistofdetectionswithinspecifiedtimeframe': retrievelistofdetectionswithinspecifiedtimeframe_command,
			'cscantifraud-retrievelistofmonitoringresultswithinspecifiedtimeframe': retrievelistofmonitoringresultswithinspecifiedtimeframe_command,
			'cscantifraud-retrievephishkitwitheventid': retrievephishkitwitheventid_command,
			'cscantifraud-startorstopmonitoringforaspecificevent': startorstopmonitoringforaspecificevent_command,
			'cscantifraud-updatetheactionwithticketid': updatetheactionwithticketid_command,
        }
