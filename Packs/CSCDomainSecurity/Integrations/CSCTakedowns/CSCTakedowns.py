...
def main() -> None:
    ...
    try:
        ...
        commands = {
    		'CSCTakedowns-controldetectionflowbyeventidandaction': controldetectionflowbyeventidandaction_command,
			'CSCTakedowns-fetchthedetectiondataandconverttopdf': fetchthedetectiondataandconverttopdf_command,
			...
			'CSCTakedowns-getlistofands': getlistofands_command,
			'CSCTakedowns-getlistoffraudtypes': getlistoffraudtypes_command,
			...
			'CSCTakedowns-performanactiononasingletarget': performanactiononasingletarget_command,
			'CSCTakedowns-retrieveeventscreenshotwitheventid': retrieveeventscreenshotwitheventid_command,
			'CSCTakedowns-retrievefilteredlistofmonitoringresultswithinspecifiedtimeframe': retrievefilteredlistofmonitoringresultswithinspecifiedtimeframe_command,
			'CSCTakedowns-retrievelistofdetectionswithinspecifiedtimeframe': retrievelistofdetectionswithinspecifiedtimeframe_command,
			'CSCTakedowns-retrievelistofmonitoringresultswithinspecifiedtimeframe': retrievelistofmonitoringresultswithinspecifiedtimeframe_command,
			'CSCTakedowns-retrievephishkitwitheventid': retrievephishkitwitheventid_command,
			'CSCTakedowns-startorstopmonitoringforaspecificevent': startorstopmonitoringforaspecificevent_command,
