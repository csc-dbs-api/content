...
class Client(BaseClient):
    ...
    def listtakedowneventswithfilters_request(self, fromDate, toDate, _andId, fraudType, ticketStatus,
                                              DetectionDate, AuthorizationDate, CompletedDate,
                                              page, limit):
...
def listtakedownevents_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    response = client.listtakedownevents_request(
        args.get('fromDate'),
        args.get('toDate'),
        args.get('page'),
        args.get('limit')
