...
def main() -> None:
    ...
    try:
        ...
        commands = {
    		'controldetectionflowbyeventidandaction': controldetectionflowbyeventidandaction_command,
			'fetchthedetectiondataandconverttopdf': fetchthedetectiondataandconverttopdf_command,
			'fetchthephishkitdatawithticketid': fetchthephishkitdatawithticketid_command,
			...
			'listtakedowneventswithfilters': listtakedowneventswithfilters_command,
			'performanactiononasingletarget': performanactiononasingletarget_command,
			'retrieveeventscreenshotwitheventid': retrieveeventscreenshotwitheventid_command,
			'retrievefilteredlistofmonitoringresultswithinspecifiedtimeframe': retrievefilteredlistofmonitoringresultswithinspecifiedtimeframe_command,
			'retrievelistofdetectionswithinspecifiedtimeframe': retrievelistofdetectionswithinspecifiedtimeframe_command,
			'retrievelistofmonitoringresultswithinspecifiedtimeframe': retrievelistofmonitoringresultswithinspecifiedtimeframe_command,
			'retrievephishkitwitheventid': retrievephishkitwitheventid_command,
			'startorstopmonitoringforaspecificevent': startorstopmonitoringforaspecificevent_command,
			'updatetheactionwithticketid': updatetheactionwithticketid_command,
        }
